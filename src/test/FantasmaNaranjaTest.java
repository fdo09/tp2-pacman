...
private Tablero tab;
	...
	public void testAtrapar2(){
		 ...
		 * por lo tanto primero tendr� que acercarse a el, y luego ir ambos en busca del Pacman.
		 * 
		 */
		...
		//Evaluamos la posici�n del FantasmaNaranaja, tiene que estar en la misma que el FantasmaAmarillo.
	...
	public void testHuir2(){
		...
		//Se mueve en unica direcci�n hasta llegar al FantasmaAmarillo.
